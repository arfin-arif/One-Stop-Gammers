      ...
      <div className="gameCard_container">
        <div className=" action_content">
          <div className="container mx-auto">
            <h1 className="gameCards_text text-2xl font-semibold mb-10">
              Action
            </h1>
            <div className="action_card_group grid grid-cols-5 gap-5 gap-y-10">
              <div className="action_card  rounded-lg px-3 bg-gray-300">
                <img
                  className="relative rounded-lg top-[-1rem] left-0 w-[240px] h-[160px] object-cover "
                  src="https://i.pinimg.com/736x/10/a3/95/10a395d25634bb5841c267bf5a0a2ba4.jpg"
                  alt=""
                />
                <h3 className="mb-3">Alchemy Stars</h3>
                <h1 className="text-lg font-semibold text-right relative bottom-3 right-3 text-gray-800">
                  Buy Items
                </h1>
              </div>
              <div className="action_card  rounded-lg px-3 bg-gray-300">
        ...
        <div className=" simulation_content">
          <div className="container mx-auto">
            <h1 className="gameCards_text text-2xl font-semibold my-10">
              Simulation
            </h1>
            <div className="simulation_card_group grid grid-cols-5 gap-5 gap-y-10">
              <div className="simulation_card  rounded-lg px-3 bg-gray-300">
                <img
                  className="relative rounded-lg top-[-1rem] left-0 w-[240px] h-[160px] object-cover "
                  src="https://i.pinimg.com/736x/10/a3/95/10a395d25634bb5841c267bf5a0a2ba4.jpg"
                  alt=""
        ...
        <div className="classic_content">
          <div className="container mx-auto">
            ...
            <div className="classic_card_group grid grid-cols-5 gap-5 gap-y-10">
              <div className="classic_card  rounded-lg px-3 bg-gray-300">
                <img
                  className="relative rounded-lg top-[-1rem] left-0 w-[240px] h-[160px] object-cover "
                  src="https://i.pinimg.com/736x/10/a3/95/10a395d25634bb5841c267bf5a0a2ba4.jpg"
                  alt=""
